  ...
  const scenarios: Record<number, Record<string, { title: string; description: string; options: { label: string; consequence: string }[] }>> = {
    ...
    11: {
      Realistic: {
        ...
        description: "Your child is being severely cyberbullied on social media. Cruel memes about them have gone viral at school, they're receiving death threats, and someone created fake inappropriate photos of them. They're refusing to go to school and showing signs of depression.",
        options: [
          { 
            label: "A) Legal action against bullies and platforms", 
            consequence: "Protection but child labeled as snitch. Happiness +10, finances -15000"
          },
          { 
            label: "B) Delete all social media and change schools", 
            consequence: "Fresh start but problem may follow. Happiness +5, finances -20000"
          },
          { 
            label: "C) Work with school for intervention program", 
            consequence: "Slow progress but addresses root causes. Happiness +15, finances -5000"
          },
          { 
            label: "D) Teach them to fight back online", 
            consequence: "Empowering but escalates situation. Happiness -10, finances -2000"
          }
        ]
      },
      Fantasy: {
        title: "Dream Walker's Curse",
        description: "Your child has developed the ability to enter and manipulate dreams. They've been helping friends with nightmares, but now they're trapped in someone else's nightmare realm and their physical body is in a coma. Dream specialists warn that forced awakening could shatter their mind.",
        options: [
          { 
            label: "A) Hire master dream walker for rescue mission", 
            consequence: "Expert help but dangerous journey. Happiness +20, finances -30000"
          },
          { 
            label: "B) Enter the dream realm yourself to save them", 
            consequence: "Parent-child bond helps but you risk getting trapped. Happiness +15, finances -10000"
          },
          { 
            label: "C) Use magical artifacts to force awakening", 
            consequence: "Quick but may cause permanent damage. Happiness -20, finances -25000"
          },
          { 
            label: "D) Wait and trust them to find their way out", 
            consequence: "Shows faith but time is running out. Happiness -15, finances -5000"
          }
        ]
      },
      Thrilling: {
        title: "Gang Recruitment Pressure",
        description: "A dangerous gang is aggressively recruiting your child, using threats against your family. They've already beaten up your child once for refusing, and now they're escalating. The police say they can't help without evidence, and witness protection isn't available for 'potential' crimes.",
        options: [
          { 
            label: "A) Hire private security and investigators", 
            consequence: "Protection but expensive and temporary. Happiness +5, finances -40000"
          },
          { 
            label: "B) Relocate family immediately", 
            consequence: "Safety but lose everything built. Happiness -10, finances -50000"
          },
          { 
            label: "C) Work with community anti-gang programs", 
            consequence: "Long-term solution but immediate danger. Happiness +10, finances -8000"
          },
          { 
            label: "D) Confront gang leaders directly", 
            consequence: "Dangerous gamble that might earn respect or death. Happiness -25, finances -5000"
          }
        ]
      }
    },
    ...
    13: {
      Realistic: {
        ...
        description: "Your child has come out as transgender and wants to start hormone therapy. Half your family is supportive, the other half threatens to cut you off. Your child is being bullied at school, and the administration refuses to use their chosen name. They're becoming severely depressed and talking about self-harm.",
        options: [
          { 
            label: "A) Full support including medical transition", 
            consequence: "Child thrives but family divides. Happiness +25, finances -25000"
          },
          { 
            label: "B) Support socially but delay medical decisions", 
            consequence: "Compromise approach with mixed results. Happiness +10, finances -10000"
          },
          { 
            label: "C) Seek family therapy to find middle ground", 
            consequence: "Slow progress but family stays together. Happiness +15, finances -15000"
          },
          { 
            label: "D) Insist they wait until they're older", 
            consequence: "Child feels rejected and pulls away. Happiness -30, finances -5000"
          }
        ]
      },
      Fantasy: {
        title: "Shapeshifter's Dilemma",
        description: "Your child's shapeshifting abilities have manifested, allowing them to take any form. They're using it to escape their identity, becoming different people daily. The Shifter's Council warns that without choosing a primary form soon, they'll lose their original identity forever and become a formless entity.",
        options: [
          { 
            label: "A) Force them to maintain human form only", 
            consequence: "Identity preserved but abilities suppressed. Happiness -15, finances -10000"
          },
          { 
            label: "B) Let them explore all forms freely", 
            consequence: "Happy but risk losing human identity. Happiness +20, finances -20000"
          },
          { 
            label: "C) Hire identity anchor specialist", 
            consequence: "Professional help to balance forms. Happiness +25, finances -35000"
          },
          { 
            label: "D) Join shapeshifter community for guidance", 
            consequence: "Peer support but isolated from humans. Happiness +15, finances -15000"
          }
        ]
      },
      Thrilling: {
        title: "Dark Web Discovery",
        description: "You discovered your child has been recruited as a hacker for a dark web crime syndicate. They've already stolen thousands in cryptocurrency and know too much to simply walk away. The syndicate has made it clear that leaving means death, but staying means becoming a career criminal.",
        options: [
          { 
            label: "A) FBI cooperation and witness protection", 
            consequence: "Safety but complete life upheaval. Happiness -10, finances -60000"
          },
          { 
            label: "B) Hire hackers to fake their death and disappear", 
            consequence: "Freedom but constant hiding. Happiness -20, finances -80000"
          },
          { 
            label: "C) Negotiate exit with syndicate leaders", 
            consequence: "Dangerous but might find compromise. Happiness +5, finances -100000"
          },
          { 
            label: "D) Use their skills to destroy syndicate", 
            consequence: "Fight back but extreme danger. Happiness -30, finances -40000"
          }
        ]
      }
    },
    14: {
      Realistic: {
        ...
        description: "Your child has been hospitalized for severe anorexia. They're at 60% of healthy body weight and their organs are starting to fail. The treatment center costs $100,000 with no guarantee of success. Your insurance won't cover it, and your child is actively resisting help, planning to run away from any facility.",
        options: [
          { 
            label: "A) Sell house to pay for best treatment", 
            consequence: "Top care but financial devastation. Happiness +20, finances -100000"
          },
          { 
            label: "B) Try outpatient treatment at home", 
            consequence: "Affordable but may not be enough. Happiness +5, finances -20000"
          },
          { 
            label: "C) Court-ordered involuntary treatment", 
            consequence: "Forces help but damages trust. Happiness -10, finances -40000"
          },
          { 
            label: "D) Let them make their own choices", 
            consequence: "Respects autonomy but life-threatening. Happiness -40, finances -10000"
          }
        ]
      },
      Fantasy: {
        title: "Blood Magic Awakening",
        description: "Your teenager's blood has awakened as the most powerful magical catalyst in generations. Every drop can grant wishes, cure diseases, or create weapons. Various factions want to harvest them, and even a paper cut causes magical chaos. The Blood Mages offer protection but would essentially own your child.",
        options: [
          { 
            label: "A) Accept Blood Mage protection and training", 
            consequence: "Safety but child becomes their property. Happiness -20, finances +50000"
          },
          { 
            label: "B) Magical suppression surgery", 
            consequence: "Removes power and danger permanently. Happiness +10, finances -60000"
          },
          { 
            label: "C) Create family blood magic circle", 
            consequence: "Family shares power and protection. Happiness +25, finances -30000"
          },
          { 
            label: "D) Go into magical witness protection", 
            consequence: "Hidden but isolated from world. Happiness -15, finances -40000"
          }
        ]
      },
      Thrilling: {
        title: "School Shooting Survivor",
        description: "Your child survived a school shooting by playing dead among their classmates' bodies. They have severe PTSD, can't return to any school, and have become agoraphobic. They're also being harassed by conspiracy theorists claiming it was fake. Your family is falling apart from the trauma.",
        options: [
          { 
            label: "A) Intensive trauma therapy and homeschooling", 
            consequence: "Healing but isolated recovery. Happiness +15, finances -50000"
          },
          { 
            label: "B) Move somewhere remote and start over", 
            consequence: "Escape triggers but running from trauma. Happiness -5, finances -70000"
          },
          { 
            label: "C) Join survivor advocacy movement", 
            consequence: "Purpose from pain but reliving trauma. Happiness +10, finances -20000"
          },
          { 
            label: "D) Sue everyone involved for damages", 
            consequence: "Potential justice but prolonged suffering. Happiness -20, finances -30000"
          }
        ]
      }
    },
    15: {
      Realistic: {
        ...
        description: "Your 15-year-old is in an abusive relationship with an 18-year-old. They have bruises they're hiding, their grades have plummeted, and they've cut off all friends. The partner has threatened to release intimate photos if they leave. Your child defends them and threatens suicide if you interfere.",
        options: [
          { 
            label: "A) Police intervention and restraining order", 
            consequence: "Legal protection but child feels betrayed. Happiness +5, finances -15000"
          },
          { 
            label: "B) Secret therapy and gradual intervention", 
            consequence: "Slow but maintains trust. Happiness +20, finances -25000"
          },
          { 
            label: "C) Forcibly separate them immediately", 
            consequence: "Stops abuse but child rebels dangerously. Happiness -15, finances -10000"
          },
          { 
            label: "D) Try to befriend partner to influence them", 
            consequence: "Risky approach that rarely works. Happiness -25, finances -5000"
          }
        ]
      },
      Fantasy: {
        title: "Prophecy's Chosen Sacrifice",
        description: "Ancient prophecy states your 15-year-old must sacrifice themselves on their 16th birthday to prevent apocalypse. Religious zealots are preparing the ritual, while a resistance group offers to help you flee to a dimension where prophecies don't work. Your child is beginning to believe they must fulfill their destiny.",
        options: [
          { 
            label: "A) Flee to prophecy-null dimension", 
            consequence: "Family safe but world potentially doomed. Happiness +30, finances -80000"
          },
          { 
            label: "B) Fight to break the prophecy's power", 
            consequence: "Dangerous battle against fate itself. Happiness -10, finances -100000"
          },
          { 
            label: "C) Find prophecy loophole with scholars", 
            consequence: "Possible solution but time running out. Happiness +15, finances -50000"
          },
          { 
            label: "D) Prepare child for heroic sacrifice", 
            consequence: "Accept fate but lose your child. Happiness -50, finances -20000"
          }
        ]
      },
      Thrilling: {
        title: "Human Trafficking Near-Miss",
        description: "Your teen was groomed online and nearly trafficked after meeting someone they thought was a fellow teenager. They escaped but the trafficking ring knows your address. Police say there's not enough evidence, and the traffickers have sent photos proving they're watching your family.",
        options: [
          { 
            label: "A) Private security and investigation firm", 
            consequence: "Professional protection and justice. Happiness +20, finances -75000"
          },
          { 
            label: "B) Disappear into witness protection", 
            consequence: "Safety but lose entire life. Happiness -15, finances -50000"
          },
          { 
            label: "C) Go public with media campaign", 
            consequence: "Pressure authorities but increase danger. Happiness +5, finances -20000"
          },
          { 
            label: "D) Take justice into your own hands", 
            consequence: "Dangerous vigilante action. Happiness -30, finances -30000"
          }
        ]
      }
    },
    ...
    17: {
      Realistic: {
        ...
        description: "You discovered your child cheated on their SATs and falsified extracurriculars on college applications. They've already been accepted to their dream Ivy League school. If exposed, they'll lose everything and face criminal charges. They claim everyone does it and you're overreacting. The statute of limitations hasn't expired.",
        options: [
          { 
            label: "A) Make them confess and withdraw applications", 
            consequence: "Ethical choice but destroys their future. Happiness -20, finances -30000"
          },
          { 
            label: "B) Keep quiet and let them attend", 
            consequence: "They succeed but built on lies. Happiness +10, finances -80000"
          },
          { 
            label: "C) Anonymous tip to protect yourself legally", 
            consequence: "Covers you but betrays your child. Happiness -35, finances -20000"
          },
          { 
            label: "D) Negotiate honest admission elsewhere", 
            consequence: "Compromise preserves some opportunities. Happiness +5, finances -40000"
          }
        ]
      },
      Fantasy: {
        title: "Magical Academy Final Trial",
        description: "Your child must pass the Deadly Seven Trials to graduate from magical academy. Each trial has a 20% fatality rate, but success grants master-level powers and prestigious positions. Failing or refusing means being stripped of all magic forever. They're terrified but determined to prove themselves.",
        options: [
          { 
            label: "A) Support their participation fully", 
            consequence: "Shows faith but may lose them. Happiness +20, finances -50000"
          },
          { 
            label: "B) Secretly sabotage trials for safety", 
            consequence: "Protects them but destroys trust if discovered. Happiness -15, finances -75000"
          },
          { 
            label: "C) Offer alternative magical education", 
            consequence: "Safe but less prestigious path. Happiness +10, finances -100000"
          },
          { 
            label: "D) Let them choose without influence", 
            consequence: "Respects autonomy with uncertain outcome. Happiness +5, finances -25000"
          }
        ]
      },
      Thrilling: {
        title: "International Spy Recruitment",
        description: "Your brilliant child has been recruited by multiple intelligence agencies. The CIA offers a full scholarship and future career, but the work is dangerous. A foreign agency offers triple the benefits but would make them a traitor. They've already been doing freelance intelligence work you didn't know about.",
        options: [
          { 
            label: "A) Encourage patriotic CIA path", 
            consequence: "Prestigious but dangerous career. Happiness +15, finances +60000"
          },
          { 
            label: "B) Forbid all intelligence work", 
            consequence: "Safety but wastes their talents. Happiness -20, finances -10000"
          },
          { 
            label: "C) Help them stay freelance and independent", 
            consequence: "Freedom but no protection. Happiness +10, finances +40000"
          },
          { 
            label: "D) Consider the foreign offer carefully", 
            consequence: "Lucrative but morally complex. Happiness -10, finances +150000"
          }
        ]
      }
    },
